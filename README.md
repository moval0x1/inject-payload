...
## text-section
- Insert payload in .text section using it inside the main function.
...
## data-section
- Insert payload in .data section using it outside the main function.
...
## rsrc-section
- Embbeded shellcode inside resource
